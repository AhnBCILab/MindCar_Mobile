...
public class CarController : MonoBehaviour
{
	...
	void Start () {
        ...
        //my added code to connect brainwave
    ...
    {
        //To show value of beta
        Beta.text = "Beta: " + Algo_Beta.ToString();
    }

    void showSpeed()
    {
        //To show speed of Car
...
//				print(" Click Connect Button Frame");
        ...
        //Algo_Beta
        if (Algo_Beta < BeginningCommmand || Algo_Beta > FinalCommmand)
        ...
        else
        {
            ...
            {
                if (Algo_Beta >= i && Algo_Beta < (i + 1))  // If it was 1, then (1 <= x < 2).
                {
                    command = i;
                    break;
                }
        ...
        //To show value of speed
        //showSpeed();

        //To move car forward
        Car.transform.Translate(new Vector3(0, 0, speed));
	...
	void OnGUI(){
        ...
        if (!Directory.Exists(Application.persistentDataPath + "/Rawdata_unity3"))
        {
            Directory.CreateDirectory(Application.persistentDataPath + "/Rawdata_unity3");
        ...
        if (!File.Exists(Application.persistentDataPath + "/Rawdata_unity3/Rawdata.txt"))
        {
            FileStream fs = new FileStream(Application.persistentDataPath + "/Rawdata_unity3/" + "Rawdata.txt", FileMode.Create, FileAccess.Write);
        ...
        {
            FileStream f = new FileStream(Application.persistentDataPath + "/Rawdata_unity3/" + "Rawdata.txt", FileMode.Append, FileAccess.Write);
